...
public ArrayList<String> bandNames = new ArrayList<String>();
  ...
  void drawContent()
  {
    ...
    if (mouseX >= x && mouseX <= x+w && mouseY >= y+10 && mouseY <= y+h+10 && graphView.lastDrag == -555 && !regionExpand && !ageExpand && !genderExpand) {
      ...
      stroke(barsColor[8]);
    fill(barsColor[8]);
    float y2 = map(integrators.get(diff).value, 0, 3150000, h-30, 10);
    if (!gendersChecked && !ageChecked && !regionChecked) {
      ...
      if (gendersChecked) {
        ...
        if (maleChecked) {
          ...
          yMales= map(integrators.get(diff).value, 0, 7150, h-30, 5);    
        ...
        if (femaleChecked && maleChecked) {
          ...
          yFemales = map(integrators.get(diff+10).value, 0, 7150, h-30, 5);    
        ...
        if (regionChecked) {
          ...
          if (europeChecked) {
            ...
            yEuropean = map(integrators.get(diff).value, 0, 8000, h-30, 5);    
          ...
          if (northAmericaChecked) {
            ...
            yNorthAmerica = map(integrators.get(diff+10).value, 0, 8000, h-30, 5);    
          ...
          if (southAmericaChecked) {
            ...
            ySouthAmerica = map(integrators.get(diff+20).value, 0, 8000, h-30, 5);    
          ...
          if (asiaChecked) {
            ...
            yAsia = map(integrators.get(diff+30).value, 0, 8000, h-30, 5);    
          ...
          if (africaChecked) {
            ...
            yAfrica = map(integrators.get(diff+40).value, 0, 8000, h-30, 5);    
          ...
          if (australiaChecked) {
            ...
            yAustralia = map(integrators.get(diff+50).value, 0, 8000, h-30, 5);    
          ...
          middleEastern = numOfMiddleEast;
            ...
            yMiddleEast = map(integrators.get(diff+60).value, 0, 8000, h-30, 5);    
          ...
          carribean = numOfCarribean;
            ...
            yCarribean = map(integrators.get(diff+70).value, 0, 8000, h-30, 5);    
          ...
          if (ageChecked) {
            ...
            if (nineYrsChecked) {
              ...
              yNine = map(integrators.get(diff).value, 0, 7000, h-30, 5);    
              rect(0, h - 30, w, yNine);
              //    System.out.println("yEuropean = "+yEuropean+" and yNorthAmerican"+yNorthAmerica);
              integrators.get(diff).update();
            }
            if (nineteenYrsChecked) {
              ...
              yNineteen = map(integrators.get(diff+10).value, 0, 7000, h-30, 5);    
            ...
            if(twentyNineYrsChecked){
              ...
              yTwentyNine = map(integrators.get(diff+20).value, 0, 7000, h-30, 5);    
            ...
            if(thirtyNineYrsChecked){
              ...
              yThirtyNine = map(integrators.get(diff+30).value, 0, 7000, h-30, 5);    
            ...
            if(fortyNineYrsChecked){
              ...
              yFortyNine = map(integrators.get(diff+40).value, 0, 7000, h-30, 5);    
            ...
            if(fiftyNineYrsChecked){
              ...
              yFiftyNine = map(integrators.get(diff+50).value, 0, 7000, h-30, 5);    
            ...
            if(sixtyOrMoreChecked){
              ...
              ySixtyMore = map(integrators.get(diff+60).value, 0, 7000, h-30, 5);    
